...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("CREATE TABLE IF DOESN'T EXISTS account(Email TEXT PRIMARY KEY , name TEXT , balance int);");
        db.execSQL("CREATE TABLE IF DOESN'T EXISTS tt(sender VARCHAR ,receiver VARCHAR,amount VARCHAR);");
